...
var ButtonIsolation = function ButtonIsolation(props) {
  ...
  return /*#__PURE__*/React__default['default'].createElement("button", {
    className: "".concat(style$2['host'], " \n                  ").concat(style$2[isSmall], " \n                  ").concat(style$2[isMiddle], " \n                  ").concat(style$2[isLarge], " \n                  ").concat(style$2[isRound], " \n                  ").concat(style$2[isRhombus], " \n                  ").concat(style$2[isConvex], " \n                  ").concat(style$2[isThick]),
    onClick: onClick
  }, icon ? /*#__PURE__*/React__default['default'].createElement("span", {
    className: style$2.icon
  }, icon) : /*#__PURE__*/React__default['default'].createElement("span", {
    className: style$2.txt
  }, text));
};
...
var style = {"host":"Bg-module_host__3TGCQ","center--flex-row":"Bg-module_center--flex-row__1Y2WR","center--flex-column":"Bg-module_center--flex-column__2S0V0"};
...
var Bg = function Bg(props) {
  ...
  return /*#__PURE__*/React__default['default'].createElement("div", {
    className: "".concat(style.host, " \n                  ").concat(style[isCenterRow], "\n                  ").concat(style[isCenterColumn]),
    style: {
